...
**Location:** [Brown-Kopel Engineering Student Achievement Center](https://maps.app.goo.gl/xtEzVAkMB1Qmtytb8)

## What Meals Are Included?

Your registration covers:

- **Friday:** Dinner (provided by [AU-CAICE](https://eng.auburn.edu/au-caice/))
...
Participants should bring a laptop capable of running a virtual machine. **VMware Workstation Pro** is the recommended hypervisor — it's free for personal use. [VirtualBox](https://www.virtualbox.org/) is also acceptable if you already have it set up.

If you're not sure how to get VMware Workstation Pro, it is available at [no cost from Broadcom](https://www.vmware.com/products/desktop-hypervisor/workstation-and-fusion).

## How Do I Register?

Fill out the form below so we can get an accurate head count for meals.

[Register here](https://docs.google.com/forms/d/e/1FAIpQLSfLW4_JRfZCvqsBos-gXNAWDmcg2kL15S39jYvUuRdclh9HhA/viewform)
...
EHC membership is open to Auburn University students. Joining gets you $5 off registration — and supports the club. You can join through [AU Involve](https://auburn.campuslabs.com/engage/organization/auehc). Dues are $10, paid via the same Venmo account listed in the registration form. When sending payment, include your full name in the memo — **"EHC Dues - First Last"** — so we can attribute it correctly.

<!--
## Flyer

![Cyber Fire 2026 Flyer](/images/2026/08/Cyber Fire2026_Flyer.png)
-->

## Acknowledgement

Special thanks to [**Los Alamos National Laboratory**](https://www.lanl.gov/), the [**Center for Artificial Intelligence and Cybersecurity Engineering (AU-CAICE)**](https://eng.auburn.edu/au-caice/), and [**Dr. Tauritz**](https://eng.auburn.edu/directory/drt0015), Director of National Laboratory Relations at Auburn University, for helping make this event possible!
