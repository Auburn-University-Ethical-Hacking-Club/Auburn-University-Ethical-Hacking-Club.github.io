...
As you can see, setting up either of these attacks can be done with relative ease, just using some [python scripts](https://github.com/s0lst1c3/evil_twin).

Slides [Source](http://www.irongeek.com/i.php?page=videos/bsideshuntsville2016/101-slaying-rogue-access-points-with-python-and-cheap-hardware-gabriel-ryan)
