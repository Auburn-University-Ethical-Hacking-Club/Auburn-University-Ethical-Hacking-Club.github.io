...
## Challenges
 ...
 _Most reversing challenges should be safe to run on your host, but it is always best to run on a virtual machine_
...
## Virus Exchange
 ...
 _Be careful with malware the below sites they host live malware_
