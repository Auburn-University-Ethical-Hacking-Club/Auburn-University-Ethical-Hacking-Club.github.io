...
In order to access Krypton you’ll need an SSH Client (puTTy for windows, native on Linux) and some basic knowledge of the Linux command line. To ssh into the box, you’ll need to connect to krypton.labs.overthewire.org with the username kryptonX where X is the level you’re on. This is better explained on the [website](http://overthewire.org/wargames/krypton/krypton0.html).
